class Arabic
  ...
  ARABIC = {
    ...
    'ٱ' => 'a',   # alef wasla
    'ة' => 'a',   # teh marbuta
    'ۃ' => 'a',   # teh marbuta goal
    'ي' => 'y',   # Arabic yeh
    'ى' => 'a',   # alef maksura
    'ﻯ' => 'a',   # alef maksura isolated form
    'ﻰ' => 'a',   # alef maksura final form
    'ﯨ' => 'a',   # Uighur Kazach Kirghiz alef maksura initial form
    'ﯩ' => 'a',   # Uighur Kazach Kirghiz alef maksura medial form
    'ٰ' => 'a',   # Arabic letter superscript alef
    'ـ' => '',    # tatweel (filler)
    'َ' => 'a',    # fatha ("-a")
    'ُ' => 'u',    # damma ("-u")
    ...
    'ڃ' => 'ny',  # Arabic letter nyeh U+0683 (used in Sindhi (snd))
    'ڄ' => 'dy',  # Arabic letter dyeh U+0684 (used in Sindhi (snd))
